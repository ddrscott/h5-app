...
export const Lobby: React.FC<LobbyProps> = ({
  ...
  return (
    <div className="min-h-screen felt-texture p-4 landscape:p-2 flex flex-col">
          ...
          <div className="flex-1 relative felt-texture rounded-lg">
              ...
              <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-center">
                ...
                <div className="mb-3">
                  ...
                  <p className="text-3xl font-mono font-bold text-gold bg-gray-900/80 rounded-lg px-4 py-2">{roomId}</p>
                </div>
